...
TODO: Question: How does the word function in the arr.map parameters come into play? Does it ever need to be defined, why is it there?
------------------------------------------------------------------------------------------------ */
...
const forLoopTwoToThe = (arr) => {
  ...
  let newArray = arr.map(i => i(Math.pow(i, 2)));
  return newArray;
};
