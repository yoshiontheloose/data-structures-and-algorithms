...
Write a function named addAnimal // note: (updateAnimal) typo
that takes in array of animals (strings) and some callback function.
...
const updateAnimal = (arr, callback) => {
  ...
  let newArray = [];
  arr.forEach(arr => {
    let newEach = callback(arr);
    newArray.push(newEach);
  });
  return newArray;
};
