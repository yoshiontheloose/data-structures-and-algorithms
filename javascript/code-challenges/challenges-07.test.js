...
//NOTE: https://codefellows.github.io/code-301-guide/curriculum/class-07/challenges/

//NOTE: Array and String Methods

// slice() - Find elements in the array (Does not modify array)
...
The function should remove three items in the array
...
Your function should use slice within a loop
and return an array of each successive string result
...
// passing i because the first array instance to pass is 0
// str.length + 1 is the part extending past the string
...
Write a function named listFoods that takes in the recipe
and returns a new array of the food items without any amount or units.
